...
import 'package:timer_app/screen/reversetimer_screen.dart';
          ...
          home: Scaffold(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Container(
                      width:
                          300.0, // Adjust the width and height to make it a perfect circle
                      height: 300.0,
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            ...
                            color: Color.fromARGB(
                                255, 43, 184, 255)), // Border properties
                      ),
                      child: Center(
                        child: Align(
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ReverseTimer()),
                );
              },
